...
- (id)init
{
   ...
   NSString *version = [NSString stringWithFormat:@"%@", [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleShortVersionString"]];
	...
	log_value = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"BriTv %@ Initialized.", version]];
	[self addToLog:@"" :nil];
   ...
   NSString *filePath = [@"~/Library/Application Support/BriTv/log.txt" stringByExpandingTildeInPath];
